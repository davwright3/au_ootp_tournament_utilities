...
def get_league_batter_stats():
    ...
    # df1 to get league stats
    df1 = df1[['PA', 'AB', 'H', '1B', '2B', '3B', 'HR', 'TB',
               'RC', 'SB', 'CS', 'SO', 'ZR', 'BB', 'IBB',
               'SF', 'HP']].sum()
    ...
    lg_stats = [lg_avg_display, lg_obp_display, lg_slg_display, lg_ops_display,
                lg_woba_display, lg_hrrate_display, lg_kRate_display,
                lg_bbRate_display]
