...
def get_individual_pitcher_stats(cid_value, team=None):
    ...
    columns = ['CID', 'ORG', 'IP', 'G.1', 'GS.1', 'W', 'L',
               'SVO', 'SV', 'BS', 'HLD', 'SD', 'MD', 'BF',
               'AB.1', 'HA', '1B.1', '2B.1', '3B.1', 'HR.1',
               'TB.1', 'R.1', 'ER', 'BB.1', 'IBB.1', 'K',
               'HP.1', 'SF.1', 'IR', 'IRS', 'QS', 'GB', 'FB']
    ...
    df1 = (df1[['CID', 'IPC', 'ER', 'BF', 'K', 'BB.1', 'HR.1']]
           .groupby(['CID'], as_index=False).sum())
